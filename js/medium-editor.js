...
(function (window) {
    ...
    var Util = {
        ...
        blockContainerElementNames: [
            ...
            // dahai: i add 'svg' and move 'img' here
            'address', 'article', 'aside', 'audio', 'canvas', 'dd', 'dl', 'dt', 'fieldset',
            'figcaption', 'figure', 'footer', 'form', 'header', 'hgroup', 'main', 'nav',
            'noscript', 'output', 'section', 'video',
            'table', 'thead', 'tbody', 'tfoot', 'tr', 'th', 'td', 'img', 'svg'
        ],

        emptyElementNames: ['br', 'col', 'colgroup', 'hr', 'input', 'source', 'wbr'],
...
(function () {
    ...
    Events.prototype = {
        ...
        setupListener: function (name) {
            ...
            switch (name) {
                ...
                case 'editableMouseover':
                    ...
                    break;
             //    case 'editableDragStart':
          			// // dahai: add 'dragstart' for svg drag
             //        this.attachToEachElement('dragstart', this.handleDragStarting);
             //    	break;
                case 'editableDrag':
                	// dahai: add 'dragstart' for svg drag
                	this.attachToEachElement('dragstart', this.handleDragStarting);
        ...
        // dahai: for svg edit
        updateMousedown: function (target, eventObj) {
            var hadFocus = this.base.getFocusedElement();
            // dahai: focus on img or svg
            if (hadFocus &&
                ...
                this.lastMousedownTarget){
                  if (this.lastMousedownTarget.parentNode && this.lastMousedownTarget.parentElement.nodeName.toLowerCase() == "svg"){
                    ...
                    svgFocus.setAttribute('img-selected', true);
                    svgFocus.classList.add('img-selected-border');
                    ...
                    //             .polygon().draw().attr('stroke-width',5).attr('fill','none').attr('stroke','orange').attr('stroke-opacity','0.5');
                  ...
                  if (this.lastMousedownTarget.nodeName.toLowerCase() == "img"){
                    ...
                    imgFocus.classList.add('img-selected-border');

                    // dahai: convert img from url to uri
                    var regex = /^\s*data:([a-z]+\/[a-z]+(;[a-z\-]+\=[a-z\-]+)?)?(;base64)?,[a-z0-9\!\$\&\'\,\(\)\*\+\,\;\=\-\.\_\~\:\@\/\?\%\s]*\s*$/i;
                    var matchDataUri;
                    matchDataUri = this.lastMousedownTarget.src.match(regex);
                    if(!matchDataUri) {
                      ...
                      // };
                      // img.src = this.lastMousedownTarget.src;
                    }
                    //toFocus = this.lastMousedownTarget;
                  }
            }
        ...
        updateFocus: function (target, eventObj) {
            ...
            // dahai: For click on img, img click
            // if (hadFocus &&
            //     eventObj.type === 'click' &&
            //     this.lastMousedownTarget &&
            //     this.lastMousedownTarget.computedRole == "img"){
            //       console.log(this.lastMousedownTarget.outerHTML);
            // }
            if (!toFocus) {
        ...
        handleBodyMousedown: function (event) {
            ...
            // dahai: for svg edit
            this.updateMousedown(event.target, event);
        },
        ...
        handleDragStarting: function (event) {
        	// dahai: add handleDragStarting for svg drag
        	this.triggerCustomEvent('editableDragStart', event, event.currentTarget);
        },
...
(function () {
    ...
    var FileDragging = MediumEditor.Extension.extend({
        ...
        init: function () {
            ...
            // dahai: add editableDragStart for svg drag
            this.subscribe('editableDragStart', this.handleDragStart.bind(this));
        ...
        handleDragStart: function (event) {
            // dahai: for svg drag
            //if(event.target.firstElementChild && event.target.firstElementChild.nodeName == 'svg'){
...
if ((event.target.id !== "iAmHere") && svgInsertPosNode && !travelSelMeetSVG()) {
                ...
                var thisDocument = this.document;
                  ...
                  img.src = imgImgElement.src;
}


                // dahai: I try to download the img and convert it to datauri encoding
                // var request = new XMLHttpRequest();
                // request.open('GET', imgImgElement.src, true);
                ...
                // base_image.src = imgImgElement.src;
                ...
                // (async function() {
                //   try {
                //     let blob = await fetch(imgImgElement.src).then(r => r.blob());
            	...
            	var html = '<br>' + htmlString.trim() + '<br>';
              var paragraphs;
              var p;
              ...
              //var addElement = this.document.createElement('template');
              if (!plainString) {
              // dahai: for image paste
                MediumEditor.util.insertHTMLCommand(this.document, html);     
              }else{
                // dahai: for text drop
                //console.log(plainString);
                // console.log(htmlString);
                html = MediumEditor.util.htmlEntities(plainString);
                MediumEditor.util.insertHTMLCommand(this.document, html);
              ...
              //   Array.prototype.slice.call(event.dataTransfer.items).forEach(function (item) {
              //       console.log(item);
...
if (!travelSelMeetSVG()) {
            ...
            fileReader.addEventListener('load', function (e) {
                ...
                // dahai: create svg from drop img file
    ...
    */
        ...
        if (dataTransfer.types) {
            for (var i = 0; i < dataTransfer.types.length; i++) {
                ...
                if(contentType != 'Files'){
                  ...
                  // dahai: if type not 'Files' then for image paste
                  data[contentType] = dataTransfer.items[0].getAsFile();
                }
            }
        }
    ...
    var PasteHandler = MediumEditor.Extension.extend({
        ...
        doPaste: function (pastedHTML, pastedPlain, editable) {
            ...
            if (!pastedPlain) {
              // dahai: for image paste
                MediumEditor.util.insertHTMLCommand(this.document, pastedHTML);     
                return;
            }
...
if (!istravelSelMeetSVG) {
        	    ...
        	    fr.onloadend = function() {
        	        ...
        	        img.onload = function() {
                      ...
                      elem.trigger('editablePaste', { currentTarget: editable, target: editable }, editable);
        	        };
        	        img.src = fr.result;
        	    };
    
        	    fr.readAsDataURL(pastedFiles);
}
    ...
    MediumEditor.prototype = {
        ...
        getFocusedElement: function () {
            ...
            this.elements.some(function (element) {
                // dahai: check is img selected?
                if (!focused && element.getAttribute('img-selected')) {
                	focused = element;
                }
